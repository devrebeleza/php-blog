...
include_once 'app/validarEntradaPadre.inc.php';

class ValidadorEntradaEditada extends ValidadorEntradaPadre{
    ...
    public function __construct($conexion, $titulo, $titulo_original, $url, $url_original, $texto, $texto_original, $checkbox, $checkbox_original){
